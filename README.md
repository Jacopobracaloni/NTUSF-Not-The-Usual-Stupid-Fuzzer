...
- Activate the virtual environment by launching `source env/bin/activate`
...
## Disclaimer
The usage of this tool should be ethical and comply with the permissions granted by the owner of the target web application. This tool was developed for educational purposes only and the owner is not responsible for any illegitimate use.
